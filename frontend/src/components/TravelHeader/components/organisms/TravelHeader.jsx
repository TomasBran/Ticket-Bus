...
function TravelHeader() {
  ...
  return (
    <div className='daisy-navbar bg-ethereal-frost sm:bg-ocean-blue sm:border-midnight-slate sm:border-2 lg:px-5 py-5 grid  md:grid-cols-12 sm:grid-cols-7 grid-cols-4 min-h-20'>
